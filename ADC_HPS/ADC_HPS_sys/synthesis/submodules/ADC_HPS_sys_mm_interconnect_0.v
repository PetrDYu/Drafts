// ADC_HPS_sys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module ADC_HPS_sys_mm_interconnect_0 (
		...
		input  wire        adc_ltc2308_0_reset_sink_reset_bridge_in_reset_reset,                //                adc_ltc2308_0_reset_sink_reset_bridge_in_reset.reset
	...
	wire  [112:0] adc_ltc2308_0_slave_agent_rf_source_data;                // adc_ltc2308_0_slave_agent:rf_source_data -> adc_ltc2308_0_slave_agent_rsp_fifo:in_data
	...
	wire  [112:0] adc_ltc2308_0_slave_agent_rsp_fifo_out_data;             // adc_ltc2308_0_slave_agent_rsp_fifo:out_data -> adc_ltc2308_0_slave_agent:rf_sink_data
	...
	wire          adc_ltc2308_0_slave_agent_rp_valid;                      // adc_ltc2308_0_slave_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] adc_ltc2308_0_slave_agent_rp_data;                       // adc_ltc2308_0_slave_agent:rp_data -> router_002:sink_data
	wire          adc_ltc2308_0_slave_agent_rp_ready;                      // router_002:sink_ready -> adc_ltc2308_0_slave_agent:rp_ready
	wire          adc_ltc2308_0_slave_agent_rp_startofpacket;              // adc_ltc2308_0_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          adc_ltc2308_0_slave_agent_rp_endofpacket;                // adc_ltc2308_0_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                       // cmd_mux:src_valid -> adc_ltc2308_0_slave_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                        // cmd_mux:src_data -> adc_ltc2308_0_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                       // adc_ltc2308_0_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                     // cmd_mux:src_channel -> adc_ltc2308_0_slave_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                               // cmd_mux:src_startofpacket -> adc_ltc2308_0_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                 // cmd_mux:src_endofpacket -> adc_ltc2308_0_slave_burst_adapter:sink0_endofpacket
	...
	wire  [111:0] adc_ltc2308_0_slave_burst_adapter_source0_data;          // adc_ltc2308_0_slave_burst_adapter:source0_data -> adc_ltc2308_0_slave_agent:cp_data
	...
	wire    [1:0] adc_ltc2308_0_slave_burst_adapter_source0_channel;       // adc_ltc2308_0_slave_burst_adapter:source0_channel -> adc_ltc2308_0_slave_agent:cp_channel
	...
	wire          adc_ltc2308_0_slave_agent_rdata_fifo_out_valid;          // adc_ltc2308_0_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] adc_ltc2308_0_slave_agent_rdata_fifo_out_data;           // adc_ltc2308_0_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          adc_ltc2308_0_slave_agent_rdata_fifo_out_ready;          // avalon_st_adapter:in_0_ready -> adc_ltc2308_0_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                           // avalon_st_adapter:out_0_valid -> adc_ltc2308_0_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                            // avalon_st_adapter:out_0_data -> adc_ltc2308_0_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                           // adc_ltc2308_0_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                           // avalon_st_adapter:out_0_error -> adc_ltc2308_0_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (adc_ltc2308_0_reset_sink_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                           //             clk.clk
		.reset                   (adc_ltc2308_0_reset_sink_reset_bridge_in_reset_reset),    //       clk_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_router router (
	...
	ADC_HPS_sys_mm_interconnect_0_router router_001 (
	...
	ADC_HPS_sys_mm_interconnect_0_router_002 router_002 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (adc_ltc2308_0_reset_sink_reset_bridge_in_reset_reset),    // cr0_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //       clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                        //       clk.clk
		.reset               (adc_ltc2308_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                        //       clk.clk
		.reset              (adc_ltc2308_0_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ADC_HPS_sys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
		...
		.in_rst_0_reset (adc_ltc2308_0_reset_sink_reset_bridge_in_reset_reset), // in_rst_0.reset
