// test_hps_system_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module test_hps_system_mm_interconnect_0 (
	...
	wire          pio_button_s1_agent_rp_valid;                             // pio_button_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] pio_button_s1_agent_rp_data;                              // pio_button_s1_agent:rp_data -> router_003:sink_data
	wire          pio_button_s1_agent_rp_ready;                             // router_003:sink_ready -> pio_button_s1_agent:rp_ready
	wire          pio_button_s1_agent_rp_startofpacket;                     // pio_button_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          pio_button_s1_agent_rp_endofpacket;                       // pio_button_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> pio_button_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> pio_button_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // pio_button_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> pio_button_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> pio_button_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> pio_button_s1_burst_adapter:sink0_endofpacket
	...
	wire          pio_button_s1_agent_rdata_fifo_out_valid;                 // pio_button_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] pio_button_s1_agent_rdata_fifo_out_data;                  // pio_button_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          pio_button_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter_001:in_0_ready -> pio_button_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> pio_button_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> pio_button_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // pio_button_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> pio_button_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~pio_LED_reset_reset_bridge_in_reset_reset),               //        clk_reset.reset_n
	...
	test_hps_system_mm_interconnect_0_router router (
	...
	test_hps_system_mm_interconnect_0_router router_001 (
	...
	test_hps_system_mm_interconnect_0_router_002 router_002 (
	...
	test_hps_system_mm_interconnect_0_router_002 router_003 (
	...
	test_hps_system_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                            //        clk.clk
		.reset              (pio_LED_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                            //        clk.clk
		.reset              (pio_LED_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (pio_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (pio_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_LED_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_hps_system_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
