...
module soc_system_mm_interconnect_0 (
	...
	wire          signal_0_s1_agent_rp_valid;                                                         // signal_0_s1_agent:rp_valid -> router_009:sink_valid
	wire  [128:0] signal_0_s1_agent_rp_data;                                                          // signal_0_s1_agent:rp_data -> router_009:sink_data
	wire          signal_0_s1_agent_rp_ready;                                                         // router_009:sink_ready -> signal_0_s1_agent:rp_ready
	wire          signal_0_s1_agent_rp_startofpacket;                                                 // signal_0_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          signal_0_s1_agent_rp_endofpacket;                                                   // signal_0_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> signal_0_s1_burst_adapter:sink0_valid
	wire  [128:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> signal_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                              // signal_0_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> signal_0_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> signal_0_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> signal_0_s1_burst_adapter:sink0_endofpacket
	wire          signal_0_s1_burst_adapter_source0_valid;                                            // signal_0_s1_burst_adapter:source0_valid -> signal_0_s1_agent:cp_valid
	wire  [128:0] signal_0_s1_burst_adapter_source0_data;                                             // signal_0_s1_burst_adapter:source0_data -> signal_0_s1_agent:cp_data
	wire          signal_0_s1_burst_adapter_source0_ready;                                            // signal_0_s1_agent:cp_ready -> signal_0_s1_burst_adapter:source0_ready
	wire    [4:0] signal_0_s1_burst_adapter_source0_channel;                                          // signal_0_s1_burst_adapter:source0_channel -> signal_0_s1_agent:cp_channel
	wire          signal_0_s1_burst_adapter_source0_startofpacket;                                    // signal_0_s1_burst_adapter:source0_startofpacket -> signal_0_s1_agent:cp_startofpacket
	wire          signal_0_s1_burst_adapter_source0_endofpacket;                                      // signal_0_s1_burst_adapter:source0_endofpacket -> signal_0_s1_agent:cp_endofpacket
	...
	wire          signal_0_s1_agent_rdata_fifo_out_valid;                                             // signal_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] signal_0_s1_agent_rdata_fifo_out_data;                                              // signal_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          signal_0_s1_agent_rdata_fifo_out_ready;                                             // avalon_st_adapter_004:in_0_ready -> signal_0_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> signal_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> signal_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // signal_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> signal_0_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (signal_0_s1_burst_adapter_source0_ready),             //              cp.ready
		.cp_valid                (signal_0_s1_burst_adapter_source0_valid),             //                .valid
		.cp_data                 (signal_0_s1_burst_adapter_source0_data),              //                .data
		.cp_startofpacket        (signal_0_s1_burst_adapter_source0_startofpacket),     //                .startofpacket
		.cp_endofpacket          (signal_0_s1_burst_adapter_source0_endofpacket),       //                .endofpacket
		.cp_channel              (signal_0_s1_burst_adapter_source0_channel),           //                .channel
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (signal_0_s1_burst_adapter_source0_valid),             //   source0.valid
		.source0_data          (signal_0_s1_burst_adapter_source0_data),              //          .data
		.source0_channel       (signal_0_s1_burst_adapter_source0_channel),           //          .channel
		.source0_startofpacket (signal_0_s1_burst_adapter_source0_startofpacket),     //          .startofpacket
		.source0_endofpacket   (signal_0_s1_burst_adapter_source0_endofpacket),       //          .endofpacket
		.source0_ready         (signal_0_s1_burst_adapter_source0_ready)              //          .ready
	);
