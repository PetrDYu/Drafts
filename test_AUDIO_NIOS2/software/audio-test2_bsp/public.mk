...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../test_AUDIO_NIOS2.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../NIOS_AUDIO.sopcinfo
...
# Design Name 
# setting SOPC_NAME is NIOS_AUDIO
SOPC_NAME := NIOS_AUDIO
...
# The SOPC System ID 
# setting SOPC_SYSID is 65793
SOPC_SYSID_FLAG += --id=65793
ELF_PATCH_FLAG  += --id 65793

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x1011050
SOPC_SYSID_FLAG += --sidp=0x1011050
ELF_PATCH_FLAG  += --sidp 0x1011050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1587240208
SOPC_SYSID_FLAG += --timestamp=1587240208
ELF_PATCH_FLAG  += --timestamp 1587240208
