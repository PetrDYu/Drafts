// NIOS_AUDIO_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module NIOS_AUDIO_mm_interconnect_1 (
		input  wire        pll_out_outclk0_clk,                                             //                                           pll_out_outclk0.clk
	...
	wire  [79:0] i2c_scl_s1_agent_rf_source_data;                                                  // i2c_scl_s1_agent:rf_source_data -> i2c_scl_s1_agent_rsp_fifo:in_data
	...
	wire  [79:0] i2c_scl_s1_agent_rsp_fifo_out_data;                                               // i2c_scl_s1_agent_rsp_fifo:out_data -> i2c_scl_s1_agent:rf_sink_data
	...
	wire         cmd_mux_src_valid;                                                                // cmd_mux:src_valid -> i2c_scl_s1_agent:cp_valid
	wire  [78:0] cmd_mux_src_data;                                                                 // cmd_mux:src_data -> i2c_scl_s1_agent:cp_data
	wire         cmd_mux_src_ready;                                                                // i2c_scl_s1_agent:cp_ready -> cmd_mux:src_ready
	wire   [1:0] cmd_mux_src_channel;                                                              // cmd_mux:src_channel -> i2c_scl_s1_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                        // cmd_mux:src_startofpacket -> i2c_scl_s1_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                          // cmd_mux:src_endofpacket -> i2c_scl_s1_agent:cp_endofpacket
	...
	wire  [79:0] i2c_sda_s1_agent_rf_source_data;                                                  // i2c_sda_s1_agent:rf_source_data -> i2c_sda_s1_agent_rsp_fifo:in_data
	...
	wire  [79:0] i2c_sda_s1_agent_rsp_fifo_out_data;                                               // i2c_sda_s1_agent_rsp_fifo:out_data -> i2c_sda_s1_agent:rf_sink_data
	...
	wire         cmd_mux_001_src_valid;                                                            // cmd_mux_001:src_valid -> i2c_sda_s1_agent:cp_valid
	wire  [78:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> i2c_sda_s1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                            // i2c_sda_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [1:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> i2c_sda_s1_agent:cp_channel
	wire         cmd_mux_001_src_startofpacket;                                                    // cmd_mux_001:src_startofpacket -> i2c_sda_s1_agent:cp_startofpacket
	wire         cmd_mux_001_src_endofpacket;                                                      // cmd_mux_001:src_endofpacket -> i2c_sda_s1_agent:cp_endofpacket
	...
	wire         i2c_scl_s1_agent_rp_valid;                                                        // i2c_scl_s1_agent:rp_valid -> router_001:sink_valid
	wire  [78:0] i2c_scl_s1_agent_rp_data;                                                         // i2c_scl_s1_agent:rp_data -> router_001:sink_data
	wire         i2c_scl_s1_agent_rp_ready;                                                        // router_001:sink_ready -> i2c_scl_s1_agent:rp_ready
	wire         i2c_scl_s1_agent_rp_startofpacket;                                                // i2c_scl_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire         i2c_scl_s1_agent_rp_endofpacket;                                                  // i2c_scl_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire         i2c_sda_s1_agent_rp_valid;                                                        // i2c_sda_s1_agent:rp_valid -> router_002:sink_valid
	wire  [78:0] i2c_sda_s1_agent_rp_data;                                                         // i2c_sda_s1_agent:rp_data -> router_002:sink_data
	wire         i2c_sda_s1_agent_rp_ready;                                                        // router_002:sink_ready -> i2c_sda_s1_agent:rp_ready
	wire         i2c_sda_s1_agent_rp_startofpacket;                                                // i2c_sda_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         i2c_sda_s1_agent_rp_endofpacket;                                                  // i2c_sda_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire         i2c_scl_s1_agent_rdata_fifo_src_valid;                                            // i2c_scl_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] i2c_scl_s1_agent_rdata_fifo_src_data;                                             // i2c_scl_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire         i2c_scl_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter:in_0_ready -> i2c_scl_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_out_0_valid;                                                    // avalon_st_adapter:out_0_valid -> i2c_scl_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                     // avalon_st_adapter:out_0_data -> i2c_scl_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                    // i2c_scl_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                    // avalon_st_adapter:out_0_error -> i2c_scl_s1_agent:rdata_fifo_sink_error
	wire         i2c_sda_s1_agent_rdata_fifo_src_valid;                                            // i2c_sda_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire  [33:0] i2c_sda_s1_agent_rdata_fifo_src_data;                                             // i2c_sda_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire         i2c_sda_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_001:in_0_ready -> i2c_sda_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_001_out_0_valid;                                                // avalon_st_adapter_001:out_0_valid -> i2c_sda_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_001_out_0_data;                                                 // avalon_st_adapter_001:out_0_data -> i2c_sda_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_001_out_0_ready;                                                // i2c_sda_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire   [0:0] avalon_st_adapter_001_out_0_error;                                                // avalon_st_adapter_001:out_0_error -> i2c_sda_s1_agent:rdata_fifo_sink_error
	...
	NIOS_AUDIO_mm_interconnect_1_router router (
	...
	NIOS_AUDIO_mm_interconnect_1_router_001 router_001 (
	...
	NIOS_AUDIO_mm_interconnect_1_router_001 router_002 (
	...
	NIOS_AUDIO_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (pll_out_outclk0_clk),                                             //        clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	NIOS_AUDIO_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (pll_out_outclk0_clk),                                             //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_AUDIO_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (pll_out_outclk0_clk),                                             //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_AUDIO_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (pll_out_outclk0_clk),                                             //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_AUDIO_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (pll_out_outclk0_clk),                                             //       clk.clk
		.reset              (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_AUDIO_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (pll_out_outclk0_clk),                                             //       clk.clk
		.reset               (mm_clock_crossing_bridge_0_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NIOS_AUDIO_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_out_outclk0_clk),                                             // in_clk_0.clk
