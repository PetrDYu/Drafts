...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1010c8
SOPC_SYSID_FLAG += --sidp=0x1010c8
ELF_PATCH_FLAG  += --sidp 0x1010c8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1587946023
SOPC_SYSID_FLAG += --timestamp=1587946023
ELF_PATCH_FLAG  += --timestamp 1587946023
