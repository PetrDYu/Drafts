...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../OSCILL.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../oscill_nios.sopcinfo
...
# Design Name 
# setting SOPC_NAME is oscill_nios
SOPC_NAME := oscill_nios
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x3101000
SOPC_SYSID_FLAG += --sidp=0x3101000
ELF_PATCH_FLAG  += --sidp 0x3101000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1587856622
SOPC_SYSID_FLAG += --timestamp=1587856622
ELF_PATCH_FLAG  += --timestamp 1587856622
